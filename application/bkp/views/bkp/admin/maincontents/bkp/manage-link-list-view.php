	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Manage Userfull Link</li>
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="panel panel-flat">
                    	...
                    	<a href="<?php echo base_url();?>index.php/admin/manage_link/add" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="fa fa-hand-o-right"></i></b>Add Userfull Link</a>												
					...
					<table class="table datatable datatable-column-search-inputs" id="">
						...
						<thead>
							...
							<tr>
								...
								<th>Userfull Link name</th>
                                
                                <th>Userfull Link Url</th>
                                
                                <th>Userfull Link Icon</th>
									...
									<ul class="icons-list">
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">												
												...
												<li><a href="<?php echo base_url(); ?>index.php/admin/manage_link/edit/<?php echo $row->id; ?>"><i class="fa fa-edit"></i> Edit</a></li>

												<li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_link/confirmDelete/<?php echo $row->id; ?>"><i class="fa fa-trash"></i> Delete</a></li>

                                                

                                                <?php if($row->published==1) { ?>

                                                <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_link/deactive/<?php echo $row->id; ?>"><i class="icon icon-cross2"></i> Deactivate</a></li>

                                                <?php } else { ?>

                                                <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_link/active/<?php echo $row->id; ?>"><i class="icon icon-checkmark3"></i> Activate</a></li>
						...
						<tfoot>
							...
							<tr>
								...
								<td>Userfull Link name</td>
                                
                                <td>Userfull Link Url</td>
                                
                                <td>Userfull Link Icon</td>
