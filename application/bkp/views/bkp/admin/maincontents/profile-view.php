        ...
        <div class="panel-body no-padding-bottom"> 
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9">
              ...
              <?php } ?>
              <?php if($user_type=='P') { ?>
              <img src="<?php echo base_url();?>uploads/pg/<?php echo $row->logo_image; ?>" height="100" width="100"/>
              <?php } ?>
              <?php } else { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9">
              <button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Profile</button>
            </div>
          </div>
