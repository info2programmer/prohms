		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="panel panel-flat">
                    	...
                    	<a href="<?php echo base_url();?>index.php/admin/manage_notice/add" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="fa fa-hand-o-right"></i></b>Add Notice</a>												
						...
						<tbody>
                         ...
                         <?php foreach($rows as $row) { ?>  
							...
							<tr>
                                ...
                                <td><?php echo date_format(date_create($row->notice_date), "d-m-Y"); ?></td>	
