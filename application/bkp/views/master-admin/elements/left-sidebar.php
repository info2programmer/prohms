  ...
  <div class="sidebar-category sidebar-category-visible">
    <div class="category-content no-padding">
      <ul class="navigation navigation-main navigation-accordion">
        ...
        <li <?php if($this->uri->segment(1)=='company_setting') { ?>class="active"<?php } ?>><a href="<?php echo base_url(); ?>master-admin/company_setting"><i class="icon-gear"></i><span>Company Settings</span></a></li>
        <?php } ?>     
      </ul>
    </div>
  </div>
