        ...
        <div class="panel-body no-padding-bottom"> 
          ...
          <?php
									...
									{  
										...
										$single_absent_in_lates = $row->single_absent_in_lates;
									 }
									 else
									 {
										$com_name = '';
         ...
         <div class="form-group">
            <label class="control-label col-lg-2">1 absent in number of lates</label>
            <div class="col-lg-10">
              <input type="text" class="form-control" placeholder="Enter 1 absent in number of lates" name="single_absent_in_lates" value="<?php if($action == 'Edit'){echo $single_absent_in_lates;} else {echo set_value('single_absent_in_lates');} ?>">
              <?php echo form_error('single_absent_in_lates'); ?> </div>
          </div>
