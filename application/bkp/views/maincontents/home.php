...
<div class="page-header">
  ...
  <div class="page-header-content">
    ...
    <div class="page-title">
      ...
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Dashboard</h4>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <!--<tr>
          ...
          <th colspan="4">HELLO ADMIN</th>

        </tr>-->

        <tr>

          <th colspan="4" style="text-align:center;"><span style="color:#26a69a; font-size:24px; text-align:center;">WELCOME TO PROHRM</span>
          <br />
          <span style="color:#26a69a; font-size:20px; text-align:center;">Human Resource and Payroll Management Software</span>
          <br /><br />
          <i class="fa fa-users" style="font-size:200px; color:#999999; text-align:center;"></i>
