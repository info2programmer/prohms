<div class="main">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-9">
        <h2 class="page-header"><strong>Useful Placement Papers</strong></h2>        
        
		<form class="form-inline" action="<?php echo base_url(); ?>front_home/placement_papers" method="post">
        <input type="hidden" name="mode" value="Placement_Paper" />
          ...
          <div class="candidates-list-item">
            <div class="candidates-list-item-heading"> 
              ...
              <div class="candidates-list-item-title">
                <div class="study_block"><i class="fa fa-clone"></i></div>
        ...
        <div class="candidates-list">
          <?php
			$Study_Material = $this->db->query("select * from td_notice_tender where role='Placement_Paper' and published=1")->result(); 
			if($Study_Material) { 
          ...
          <div class="candidates-list-item">
            <div class="candidates-list-item-heading"> 
              ...
              <div class="candidates-list-item-title">
                <div class="study_block"><i class="fa fa-clone"></i></div>
                <h2><strong>Placement Papers</strong> :: <a target="_blank" href="<?php echo base_url(); ?>uploads/notice/<?php echo $sm->filename; ?>" style="text-decoration:none"><?php echo $sm->title; ?></a></h2>
                <!--<h3><span>Physics</span><span>Exam</span></h3>-->
              </div>
              <!-- /.candidates-list-item-title --> 
            </div>
