...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Manage</span> Leave details of <strong><?php echo $emp_per->emp_name; ?></strong></h4>
    </div>
  ...
  <div class="breadcrumb-line breadcrumb-line-component">
    <ul class="breadcrumb">
      ...
      <li class="active">Manage Leave details of <strong><?php echo $emp_per->emp_name; ?></strong></li>
    </ul>
...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <table class="table datatable-button-html5-columns">
	  ...
	  $leave_allot = $this->db->query("select * from td_leave_allocation_details where leave_allocation_details_id='$row->leave_type'")->row();
