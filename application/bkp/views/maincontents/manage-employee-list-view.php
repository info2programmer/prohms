...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Manage</span> Employee</h4>
    </div>
...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <a href="<?php echo base_url(); ?>manage_employee/add" class="btn btn-primary">Add Employee</a>
