...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Manage</span> Leave Assign</h4>
    </div>
  ...
  <div class="breadcrumb-line breadcrumb-line-component">
    <ul class="breadcrumb">
      ...
      <li class="active">Manage Leave Assign</li>
    </ul>
...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <a href="<?php echo base_url(); ?>manage_leave_assign/add" class="btn btn-primary">Add Leave Assign</a>
    ...
    <table class="table datatable-button-html5-columns">
	  ...
	  ?>
        <tr>
          ...
          <!--<td><?php echo date_format(date_create($row->leave_date), "d-m-Y"); ?></td>
          <td><?php echo $row->leave_type; ?></td>
          <td>
          <?php if($row->published==1) { ?>
          <a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_leave_assign/deactive/<?php echo $row->leave_assign_id; ?>"><span class="label label-success">Active</span></a>
          <?php } else { ?>
          <a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_leave_assign/active/<?php echo $row->leave_assign_id; ?>"><span class="label label-danger">Inactive</span></a>
          <?php } ?>
          </td>-->
          <td>          	
            <!--<div class="col-md-3 col-sm-4"><a href="<?php echo base_url(); ?>manage_leave_assign/user_details/<?php echo $emp_details->emp_id; ?>"><i class="fa fa-user" aria-hidden="true"></i></a></div>-->
            <div class="col-md-3 col-sm-4"><a href="<?php echo base_url(); ?>manage_leave_assign/leave_details/<?php echo $emp_details->emp_id; ?>"><i class="fa fa-pagelines" aria-hidden="true"></i></a></div>
