...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i>  Employee <span class="text-semibold">Profile</span></h4>
    </div>
													...
													<div class="panel panel-flat timeline-content">
														...
														<div class="panel-body">
															...
															<h6 class="content-group">
																<?php echo $rows->department_name;?> <a href="#"><?php echo $rows->designation_name;?></a> : <?php echo $rows->emp_code?>
															</h6>
																	...
																	<div class="row">
																		<div class="col-sm-12">
																			...
																			<ul class="list list-unstyled li_border">
                                                                                ...
                                                                                <li><span class="text-semibold">Location:</span> <?php echo $rows->location;?></li>
