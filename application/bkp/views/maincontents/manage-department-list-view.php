...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Manage</span> Department</h4>
    </div>
...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <a href="<?php echo base_url(); ?>manage_department/add" class="btn btn-primary">Add Department</a>
    ...
    <table class="table datatable-button-html5-columns">
      ...
      <?php if($rows) { $s=1; foreach($rows as $row) { ?>
        <tr>
          ...
          <a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_department/deactive/<?php echo $row->department_id; ?>"><span class="label label-success">Active</span></a>
          <?php } else { ?>
          <a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_department/active/<?php echo $row->department_id; ?>"><span class="label label-danger">Inactive</span></a>
          <?php } ?>
          </td>
          <td>          	
            <div class="col-md-3 col-sm-4"><a href="<?php echo base_url(); ?>manage_department/edit/<?php echo $row->department_id; ?>"><i class="fa fa-edit"></i></a></div>
            <!--<div class="col-md-3 col-sm-4"><a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_department/confirmDelete/<?php echo $row->department_id; ?>"><i class="fa fa-trash"></i></a></div>-->
          </td>
        </tr>
     <?php } } else { ?>
