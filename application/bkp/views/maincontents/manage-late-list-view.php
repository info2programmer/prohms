...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Manage</span> Late</h4>
    </div>
  ...
  <div class="breadcrumb-line breadcrumb-line-component">
    <ul class="breadcrumb">
      ...
      <li class="active">Manage Late</li>
    </ul>
...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <a href="<?php echo base_url(); ?>manage_late/add" class="btn btn-primary">Add Late</a>
    ...
    <table class="table datatable-button-html5-columns">
      ...
      <?php if($rows) { $s=1; foreach($rows as $row) { ?>
        <tr>
          ...
          <a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_late/deactive/<?php echo $row->late_id; ?>"><span class="label label-success">Active</span></a>
          <?php } else { ?>
          <a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_late/active/<?php echo $row->late_id; ?>"><span class="label label-danger">Inactive</span></a>
          <?php } ?>
          </td>
          <td>          	
            <div class="col-md-3 col-sm-4"><a href="<?php echo base_url(); ?>manage_late/edit/<?php echo $row->late_id; ?>"><i class="fa fa-edit"></i></a></div>
            <!--<div class="col-md-3 col-sm-4"><a onClick="return confirm('Are you sure ?'); " href="<?php echo base_url(); ?>manage_late/confirmDelete/<?php echo $row->late_id; ?>"><i class="fa fa-trash"></i></a></div>-->
          </td>
        </tr>
     <?php } } else { ?>
