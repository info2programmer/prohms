	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<div class="page-title">
				...
				<h4><i class="fa fa-th-large position-left"></i> Manage Notice</h4>
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url(); ?>index.php/admin/manage_notice">Manage Notice</a></li>

				<li class="active"><?php echo $action; ?> Notice</li>
						...
						<!--<form class="form-horizontal" action="form_basic.htm#">	-->						
						 ...
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
                            ...
                            <div class="form-group">
								...
								<label class="control-label col-lg-2">Notice Title</label>

								<div class="col-lg-10">

									

                                    <input type="text" class="form-control" placeholder="Enter Notice Title" name="title" value="<?php if($action == 'Edit'){echo $title;} else {echo set_value('title');} ?>">
                            ...
                            <div class="form-group">
								...
								<label class="control-label col-lg-2">Notice Role</label>
                            ...
                            <div class="form-group">
								...
								<label class="control-label col-lg-2">Notice Date</label>
							...
							<div class="form-group">
								...
								<label class="control-label col-lg-2">Notice</label>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Notice</button>
