...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <a href="<?php echo base_url(); ?>leave_application/add" class="btn btn-primary">Send New Leave Application</a>
    ...
    <table class="table datatable-button-html5-columns">
	  ...
	  ?>
        ...
        <strong><tr>
          ...
          <td><?php echo date_format(date_create($row->leave_from), "d M, Y"); ?></td>
		  <td><?php echo date_format(date_create($row->leave_to), "d M, Y"); ?></td>	
          <td><?php echo $row->application_subject; ?><?php echo ($reply_count>0)?' ('.$reply_count.')':''; ?></td>

          <td>          	

            <div class="col-md-3 col-sm-4"><a href="<?php echo base_url(); ?>leave_application/view/<?php echo $row->application_id; ?>"><i class="fa fa-eye"></i></a></div>
