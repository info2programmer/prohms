...
<div class="page-header">
  <div class="page-header-content">
    <div class="page-title">
      <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Manage</span> Salary Head Value</h4>
    </div>
  ...
  <div class="breadcrumb-line breadcrumb-line-component">
    <ul class="breadcrumb">
      ...
      <li class="active">Manage Salary Head Value</li>
    </ul>
...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <a href="<?php echo base_url(); ?>manage_salary_head_value/add" class="btn btn-primary">Add Salary Head Value</a>
    ...
    <table class="table datatable-button-html5-columns">
      ...
      <?php if($rows) { $s=1; foreach($rows as $row) { ?>
        <tr>
          ...
          <td>          	
            <div class="col-md-3 col-sm-4"><a href="<?php echo base_url(); ?>manage_salary_head_value/edit/<?php echo $row->salary_head_value_id; ?>"><i class="fa fa-edit"></i></a></div>
          </td>
        </tr>
     <?php } } else { ?>
