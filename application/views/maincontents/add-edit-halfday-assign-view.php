      ...
      <div class="page-header">
        <div class="page-header-content">
          <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><?php echo $action; ?></span> Halfday Assign</h4>
          </div>
        </div>
        <div class="breadcrumb-line breadcrumb-line-component">
          <ul class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>user"><i class="icon-home2 position-left"></i> Dashboard</a></li>
            <li><a href="<?php echo base_url(); ?>manage_halfday_assign">Manage Halfday Assign</a></li>
            <li class="active"><?php echo $action; ?> Halfday Assign</li>
          </ul>
        </div>
      </div>
      <!-- /page header --> 
        ...
        <div class="panel panel-flat">
          ...
          <div class="panel-body">
            ...
            <?php
				if(isset($row)){  
					$emp_id = $row->emp_id;
					$halfday_date = $row->halfday_date;
					$halfday_type = $row->halfday_type;
				} else {
					$emp_id = '';
					$halfday_date = '';
					$halfday_type = '';
			...
			?>
              ...
              <legend class="text-bold">Halfday Assign Inputs</legend>
              ...
              <!-- Basic text input -->
              <div class="form-group">
                <label class="control-label col-lg-3">Halfday date <span class="text-danger">*</span></label>
                <div class="col-lg-9">
                	<div class="input-group">
                  	<span class="input-group-addon"><i class="icon-calendar5"></i></span>
					<input type="text" class="form-control pickadate-accessibility" placeholder="Select Halfday date" name="halfday_date" value="<?php if($action == 'Edit'){echo $halfday_date;} else {echo set_value('halfday_date');} ?>">
                  	<?php echo form_error('halfday_date'); ?>
                    </div>
                </div>
              </div>
              <!-- /basic text input -->
              <!-- Basic text input -->
              <div class="form-group">
                <label class="control-label col-lg-3">Halfday type <span class="text-danger">*</span></label>
                <div class="col-lg-9">                
                    <!--<select name="halfday_type1" class="select" id="city_dropdown">
                    	<option value="" selected="selected" hidden>Select a Leave type</option>
                        <option value="M">Male</option>
                    </select>-->
                    <div id="city_id"></div>
                  <?php echo form_error('halfday_type'); ?>
                </div>
              </div>
              <!-- /basic text input -->
