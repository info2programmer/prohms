      ...
      <div class="page-header">
        ...
        <div class="breadcrumb-line breadcrumb-line-component">
          <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>manage_attendance">Upload Attendance Sheet</a></li>
            <li class="active"><?php echo $action; ?> Attendance Sheet</li>
          </ul>
        </div>
      </div>
      <!-- /page header --> 
        ...
        <div class="panel panel-flat">
          ...
          <div class="panel-body">
            <?php $attributes = array('class' => 'form-horizontal', 'id' => 'myform');echo form_open_multipart('',$attributes); ?>
              ...
              <legend class="text-bold">Upload Attendance Sheet</legend>
              	<div class="form-group">
                    <label class="control-label col-lg-3">Upload Attendance Sheet</label>
                    <div class="col-lg-9">
                      <input type="file" name="slider_image" class="file-styled">
                      <span style="font-weight:600;">(Upload specified excel sheet)</span>
                    </div>
                </div>
