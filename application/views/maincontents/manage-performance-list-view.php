...
<div class="content">
  ...
  <div class="panel panel-flat">
    ...
    <form class="form-inline" method="post" action="<?php echo base_url(); ?>manage_performance">
        ...
        <div class="form-group">
        <?php $emps = $this->db->query("select distinct(emp_id) from td_employee_performance where published=1 order by emp_id asc")->result(); ?>
          <select name="emp_id" id="emp_id" data-placeholder="Select a Team Member" class="select">
             ...
             <option value="<?php echo $emp->emp_id; ?>"><?php echo $emp->emp_id; ?></option>
             <?php } } else { ?>
