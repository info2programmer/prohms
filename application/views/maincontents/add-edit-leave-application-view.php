					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">							
							...
							<?php $attributes = array('class' => 'form-horizontal', 'id' => 'myform');echo form_open_multipart('',$attributes); ?>
                                  ...
                                  <!-- Basic text input -->
                                  <div class="form-group">                    
                                    <label class="control-label col-lg-2">Application from date <span class="text-danger">*</span></label>                    
                                    <div class="col-lg-10">                    
                                        <div class="input-group">                    
                                        <span class="input-group-addon"><i class="icon-calendar5"></i></span>                    
                                        <input type="text" class="form-control pickadate" placeholder="Select Application from date" name="leave_from" id="leave_from" value="<?php if($action == 'Edit'){echo $leave_from;} else {echo set_value('leave_from');} ?>" required="required">                    
                                  ...
                                  <!-- Basic text input -->
                                  <div class="form-group">                    
                                    <label class="control-label col-lg-2">Application to date <span class="text-danger">*</span></label>                    
                                    <div class="col-lg-10">                    
                                        <div class="input-group">                    
                                        <span class="input-group-addon"><i class="icon-calendar5"></i></span>                    
                                        <input type="text" class="form-control pickadate" placeholder="Select Application to date" name="leave_to" id="leave_to" value="<?php if($action == 'Edit'){echo $leave_to;} else {echo set_value('leave_to');} ?>" required="required">                    
