...
<div class="navbar-collapse collapse" id="navbar-mobile"> 
  ...
  <ul class="nav navbar-nav navbar-right">    
    <li class="dropdown dropdown-user"> <a class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo base_url(); ?>material/assets/images/logo.png" alt=""> <span><?php echo ($this->session->userdata('username'))?$this->session->userdata('username'):$this->session->userdata('username1'); ?>
    <?php echo $this->session->userdata('username2'); ?>
      ...
      <?php } elseif($this->session->userdata('username2')) { ?>
      	<li><a href="<?php echo base_url(); ?>master-admin/site_setting"><i class="icon-user-plus"></i> My profile</a></li>        
        <li><a href="<?php echo base_url(); ?>master-admin/user/change_password"><i class="icon-cog5"></i> Account settings</a></li>
      	<li><a href="<?php echo base_url(); ?>master-admin/user/logout"><i class="icon-switch2"></i> Logout</a></li>
      <?php } ?>  
      </ul>
    </li>
  </ul>
