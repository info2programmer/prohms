...
class Manage_attendance extends CI_Controller {
	...
	function attendance_report()
	{
		...
		$data['left_sidebar'] = $this->load->view('elements/left-sidebar','',true);
		$data['footer'] = $this->load->view('elements/footer','',true);
		$data['maincontent']=$this->load->view('maincontents/attendance-report-view',$data,true);
		$this->load->view('layout-after-login',$data);	
	}
	...
	function attendance_sheet($id)
	{
		...
		$data['left_sidebar'] = $this->load->view('elements/left-sidebar','',true);
		$data['footer'] = $this->load->view('elements/footer','',true);
		$data['maincontent']=$this->load->view('maincontents/daily-attendance-view',$data,true);
		$this->load->view('layout-after-login',$data);
	}
	...
	{	
		...
		if($this->input->post('mode')=='tab')
		{
			...
			{				
				...
				$fields = array(
								'attendance_date'=>date_format(date_create($this->input->post('attendance_date')), "Y-m-d"),
								'branch_id'=>$branch_id,
								'published'=>1							
								);
	...
	function ajax_call() 
	{
        if (isset($_POST) && isset($_POST['emp_id'])) 
		{
			$newrow = '<div class="form-group">
							<div class="col-lg-4">
								<strong>Team Member Name (Employee Code)</strong>
							</div>
							<div class="col-lg-4">
